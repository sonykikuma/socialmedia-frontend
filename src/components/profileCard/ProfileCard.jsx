      ...
      >
        ...
        <Link to={`/mypost/${user?._id}`} style={{ textDecoration: "none" }}>
          <h3
            ...
            style={{
              textDecoration: "none",
              color: isActive(`/mypost/${user?._id}`) ? "#0e5ad4" : "inherit",
              fontWeight: isActive(`/mypost/${user?._id}`) ? "bold" : "normal",
        ...
        <Link
          ...
          style={{
            textDecoration: "none",
            color: isActive(`/bookmarks/${user?._id}`) ? "#0e5ad4" : "inherit",
            fontWeight: isActive(`/bookmarks/${user?._id}`) ? "bold" : "normal",
        ...
        >
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-bookmark text-primary"
            viewBox="0 0 16 16"
          >
